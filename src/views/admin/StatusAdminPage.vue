<template>
  <div class="grid grid-cols-12 items-center mb-2">
    <div class="col-start-1 col-end-2">
      <BaseButton icon="fa-solid fa-file-circle-plus" description="" @click="isModalStatusOpen = true" />
    </div>
  ...
  <div v-show="foundStatus !== 0" class="p-5 bg-white shadow-md rounded mb-3 overflow-x-auto">
    <table class="w-full text-sm text-left text-gray-800">
      ...
      <tbody>
        <tr v-for="(item, index) in filteredList(statusList)" :key="index" class="bg-white border-b">
